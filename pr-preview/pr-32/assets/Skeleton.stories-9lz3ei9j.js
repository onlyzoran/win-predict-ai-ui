import{d as c,c as d,n as i,u as m,o as p}from"./iframe-B5mGNOHy.js";import{c as u}from"./cn-DaT-yT0k.js";import"./preload-helper-DR0Ra8Iv.js";const s=c({__name:"Skeleton",props:{class:{type:[Boolean,null,String,Object,Array]}},setup(t){const o=t;return(k,f)=>(p(),d("div",{"data-slot":"skeleton",class:i(m(u)("bg-accent animate-pulse rounded-md",o.class))},null,2))}});s.__docgenInfo={exportName:"default",displayName:"Skeleton",description:"",tags:{},props:[{name:"class",required:!1,type:{name:"TSIndexedAccessType"}}],sourceFiles:["/home/runner/work/win-predict-ai-ui/win-predict-ai-ui/src/components/ui/skeleton/Skeleton.vue"]};const w={title:"Win Predict AI / UI / Skeleton",component:s,tags:["autodocs"]},e={render:()=>({components:{Skeleton:s},template:'<Skeleton class="h-4 w-48" />'})},n={globals:{theme:"slate-teal-light"},render:e.render},a={globals:{theme:"slate-teal-dark"},render:e.render},l={render:()=>({components:{Skeleton:s},template:`
