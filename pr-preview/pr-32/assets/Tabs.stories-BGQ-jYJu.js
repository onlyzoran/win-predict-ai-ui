import{b as T,z as f,C as x,d as L,I,g as y}from"./index-BRmrF3c1.js";import{_ as a,a as r,b as s,c as t}from"./TabsContent-OhMZp2Bm.js";import"./iframe-CZbg21jV.js";import"./preload-helper-DR0Ra8Iv.js";import"./Presence-BxBsFUlv.js";import"./Primitive-B616n9Qm.js";import"./index-BfW2HXGB.js";import"./index-D7g1-zI5.js";import"./useForwardExpose-DTCiqJDU.js";import"./RovingFocusGroup-By-EjTts.js";import"./createContext-9E_p4YM4.js";import"./useId-DCtzg9yx.js";import"./cn-DaT-yT0k.js";const z={title:"Win Predict AI / UI / Tabs",component:t,tags:["autodocs"]};function h(){return`
  ...
  `}const n={render:()=>({components:{Tabs:t,TabsList:s,TabsTrigger:r,TabsContent:a},template:h()})},o={globals:{theme:"slate-teal-light"},render:()=>({components:{Tabs:t,TabsList:s,TabsTrigger:r,TabsContent:a},template:h()})},d={globals:{theme:"slate-teal-dark"},render:()=>({components:{Tabs:t,TabsList:s,TabsTrigger:r,TabsContent:a},template:h()})},i={render:()=>({components:{Tabs:t,TabsList:s,TabsTrigger:r,TabsContent:a},template:`
  ...
  `}const l={render:()=>({components:{Tabs:t,TabsList:s,TabsTrigger:r,TabsContent:a,IconSearch:x,IconPin:f,IconPencil:T},template:v()})},c={globals:{theme:"slate-teal-light"},render:()=>({components:{Tabs:t,TabsList:s,TabsTrigger:r,TabsContent:a,IconSearch:x,IconPin:f,IconPencil:T},template:v()})},b={globals:{theme:"slate-teal-dark"},render:()=>({components:{Tabs:t,TabsList:s,TabsTrigger:r,TabsContent:a,IconSearch:x,IconPin:f,IconPencil:T},template:v()})},u={render:()=>({components:{Tabs:t,TabsList:s,TabsTrigger:r,TabsContent:a,IconSearch:x,IconPin:f,IconPencil:T},template:`
  ...
  `}const w={Tabs:t,TabsList:s,TabsTrigger:r,TabsContent:a,IconGripVertical:y,IconFlag:I,IconArrowsSort:L},g={render:()=>({components:w,template:C()})},m={globals:{theme:"slate-teal-light"},render:()=>({components:w,template:C()})},p={globals:{theme:"slate-teal-dark"},render:()=>({components:w,template:C()})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: () => ({
    components: {
      Tabs,
      TabsList,
...
}`,...p.parameters?.docs?.source}}};const O=["Default","Light","Dark","NarrowScroll","WithIcons","WithIconsLight","WithIconsDark","IconOnly","LeagueDetail","LeagueDetailLight","LeagueDetailDark"];export{d as Dark,n as Default,u as IconOnly,g as LeagueDetail,p as LeagueDetailDark,m as LeagueDetailLight,o as Light,i as NarrowScroll,l as WithIcons,b as WithIconsDark,c as WithIconsLight,O as __namedExportsOrder,z as default};
