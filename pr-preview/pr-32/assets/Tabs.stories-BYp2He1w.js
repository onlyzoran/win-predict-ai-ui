import{b as R,z as V,C as N,d as ae,I as se,g as re}from"./index--yy_xmLr.js";import{d as h,p as Q,C as ne,D as oe,o as x,b as y,w as b,e as A,u as t,a as w,j as C,B as le,k as J,r as X,Q as ie,$ as de,l as ue,h as ce,Y as pe,W as be,m as j}from"./iframe-CEcj8ys-.js";import{i as me,a as ge,e as fe,w as Te,f as ve,u as he,P as xe,R as ye,b as we,c as O}from"./RovingFocusGroup-BUDQFy0z.js";import{u as W}from"./useForwardExpose-3zj45elM.js";import{P as I}from"./Primitive-DgBgeqSA.js";import{c as Ce}from"./createContext-sQmaukuv.js";import{u as Z}from"./useId-BZJGG6rp.js";import{c as Ie}from"./index-qujQPUfq.js";import{c as z}from"./cn-DaT-yT0k.js";import{r as K}from"./index-GzIrTbA5.js";import"./preload-helper-DR0Ra8Iv.js";var _e=h({__name:"RovingFocusItem",props:{tabStopId:{type:String,required:!1},focusable:{type:Boolean,required:!1,default:!0},active:{type:Boolean,required:!1},allowShiftKey:{type:Boolean,required:!1},asChild:{type:Boolean,required:!1},as:{type:null,required:!1,default:"span"}},setup(n){const a=n,s=me(),e=Z(),i=C(()=>a.tabStopId||e),u=C(()=>s.currentTabStopId.value===i.value),{getItems:c,CollectionItem:o}=ge();Q(()=>{a.focusable&&s.onFocusableItemAdd()}),ne(()=>{a.focusable&&s.onFocusableItemRemove()}),oe(()=>a.focusable,(r,l)=>{r!==l&&(r?s.onFocusableItemAdd():s.onFocusableItemRemove())});function p(r){if(r.key==="Tab"&&r.shiftKey){s.onItemShiftTab();return}if(r.target!==r.currentTarget)return;const l=fe(r,s.orientation.value,s.dir.value);if(l!==void 0){if(r.metaKey||r.ctrlKey||r.altKey||!a.allowShiftKey&&r.shiftKey)return;r.preventDefault();let d=[...c().map(g=>g.ref).filter(g=>g.dataset.disabled!=="")];if(l==="last")d.reverse();else if(l==="prev"||l==="next"){l==="prev"&&d.reverse();const g=d.indexOf(r.currentTarget);d=s.loop.value?Te(d,g+1):d.slice(g+1)}le(()=>ve(d))}}return(r,l)=>(x(),y(t(o),null,{default:b(()=>[A(t(I),{tabindex:u.value?0:-1,"data-orientation":t(s).orientation.value,"data-active":r.active?"":void 0,"data-disabled":r.focusable?void 0:"",as:r.as,"as-child":r.asChild,onMousedown:l[0]||(l[0]=d=>{r.focusable?t(s).onItemFocus(i.value):d.preventDefault()}),onFocus:l[1]||(l[1]=d=>t(s).onItemFocus(i.value)),onKeydown:p},{default:b(()=>[w(r.$slots,"default")]),_:3},8,["tabindex","data-orientation","data-active","data-disabled","as","as-child"])]),_:3}))}}),Se=_e;const[E,ke]=Ce("TabsRoot");var Le=h({__name:"TabsRoot",props:{defaultValue:{type:null,required:!1},orientation:{type:String,required:!1,default:"horizontal"},dir:{type:String,required:!1},activationMode:{type:String,required:!1,default:"automatic"},modelValue:{type:null,required:!1},unmountOnHide:{type:Boolean,required:!1,default:!0},asChild:{type:Boolean,required:!1},as:{type:null,required:!1}},emits:["update:modelValue"],setup(n,{emit:a}){const s=n,e=a,{orientation:i,unmountOnHide:u,dir:c}=J(s),o=he(c);W();const p=Ie(s,"modelValue",e,{defaultValue:s.defaultValue,passive:s.modelValue===void 0}),r=X(),l=ie(new Set);return ke({modelValue:p,changeModelValue:d=>{p.value=d},orientation:i,dir:o,unmountOnHide:u,activationMode:s.activationMode,baseId:Z(void 0,"reka-tabs"),tabsList:r,contentIds:l,registerContent:d=>{l.value=new Set([...l.value,d])},unregisterContent:d=>{const g=new Set(l.value);g.delete(d),l.value=g}}),(d,g)=>(x(),y(t(I),{dir:t(o),"data-orientation":t(i),"as-child":d.asChild,as:d.as},{default:b(()=>[w(d.$slots,"default",{modelValue:t(p)})]),_:3},8,["dir","data-orientation","as-child","as"]))}}),Pe=Le;function ee(n,a){return`${n}-trigger-${a}`}function te(n,a){return`${n}-content-${a}`}var Be=h({__name:"TabsContent",props:{value:{type:[String,Number],required:!0},forceMount:{type:Boolean,required:!1},asChild:{type:Boolean,required:!1},as:{type:null,required:!1}},setup(n){const a=n,{forwardRef:s}=W(),e=E(),i=C(()=>ee(e.baseId,a.value)),u=C(()=>te(e.baseId,a.value)),c=C(()=>a.value===e.modelValue.value),o=X(c.value);return Q(()=>{e.registerContent(a.value),requestAnimationFrame(()=>{o.value=!1})}),de(()=>{e.unregisterContent(a.value)}),(p,r)=>(x(),y(t(xe),{present:p.forceMount||c.value,"force-mount":""},{default:b(({present:l})=>[A(t(I),{id:u.value,ref:t(s),"as-child":p.asChild,as:p.as,role:"tabpanel","data-state":c.value?"active":"inactive","data-orientation":t(e).orientation.value,"aria-labelledby":i.value,hidden:!l,tabindex:"0",style:ue({animationDuration:o.value?"0s":void 0})},{default:b(()=>[!t(e).unmountOnHide.value||l?w(p.$slots,"default",{key:0}):ce("v-if",!0)]),_:2},1032,["id","as-child","as","data-state","data-orientation","aria-labelledby","hidden","style"])]),_:3},8,["present"]))}}),De=Be,$e=h({__name:"TabsList",props:{loop:{type:Boolean,required:!1,default:!0},asChild:{type:Boolean,required:!1},as:{type:null,required:!1}},setup(n){const a=n,{loop:s}=J(a),{forwardRef:e,currentElement:i}=W(),u=E();return u.tabsList=i,(c,o)=>(x(),y(t(ye),{"as-child":"",orientation:t(u).orientation.value,dir:t(u).dir.value,loop:t(s)},{default:b(()=>[A(t(I),{ref:t(e),role:"tablist","as-child":c.asChild,as:c.as,"aria-orientation":t(u).orientation.value},{default:b(()=>[w(c.$slots,"default")]),_:3},8,["as-child","as","aria-orientation"])]),_:3},8,["orientation","dir","loop"]))}}),Me=$e,Fe=h({__name:"TabsTrigger",props:{value:{type:[String,Number],required:!0},disabled:{type:Boolean,required:!1,default:!1},asChild:{type:Boolean,required:!1},as:{type:null,required:!1,default:"button"}},setup(n){const a=n,{forwardRef:s}=W(),e=E(),i=C(()=>ee(e.baseId,a.value)),u=C(()=>e.contentIds.value.has(a.value)?te(e.baseId,a.value):void 0),c=C(()=>a.value===e.modelValue.value);return(o,p)=>(x(),y(t(Se),{"as-child":"",focusable:!o.disabled,active:c.value},{default:b(()=>[A(t(I),{id:i.value,ref:t(s),role:"tab",type:o.as==="button"?"button":void 0,as:o.as,"as-child":o.asChild,"aria-selected":c.value?"true":"false","aria-controls":u.value,"data-state":c.value?"active":"inactive",disabled:o.disabled,"data-disabled":o.disabled?"":void 0,"data-orientation":t(e).orientation.value,onMousedown:p[0]||(p[0]=be(r=>{!o.disabled&&r.ctrlKey===!1?t(e).changeModelValue(o.value):r.preventDefault()},["left"])),onKeydown:p[1]||(p[1]=pe(r=>t(e).changeModelValue(o.value),["enter","space"])),onFocus:p[2]||(p[2]=()=>{const r=t(e).activationMode!=="manual";!c.value&&!o.disabled&&r&&t(e).changeModelValue(o.value)})},{default:b(()=>[w(o.$slots,"default")]),_:3},8,["id","type","as","as-child","aria-selected","aria-controls","data-state","disabled","data-disabled","data-orientation"])]),_:3},8,["focusable","active"]))}}),qe=Fe;const m=h({__name:"Tabs",props:{defaultValue:{},orientation:{default:"horizontal"},dir:{},activationMode:{},modelValue:{},unmountOnHide:{type:Boolean},asChild:{type:Boolean},as:{}},emits:["update:modelValue"],setup(n,{emit:a}){const i=we(n,a);return(u,c)=>(x(),y(t(Pe),j({"data-slot":"tabs"},t(i)),{default:b(()=>[w(u.$slots,"default")]),_:3},16))}});m.__docgenInfo={exportName:"default",displayName:"Tabs",description:"",tags:{},props:[{name:"orientation",defaultValue:{func:!1,value:"'horizontal'"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/win-predict-ai-ui/win-predict-ai-ui/src/components/ui/tabs/Tabs.vue"]};const f=h({__name:"TabsList",props:{loop:{type:Boolean},asChild:{type:Boolean},as:{},class:{type:[Boolean,null,String,Object,Array]}},setup(n){const a=n,s=K(a,"class"),e=O(s);return(i,u)=>(x(),y(t(Me),j({"data-slot":"tabs-list"},t(e),{class:t(z)("inline-flex h-9 w-full max-w-full items-center justify-start gap-1 overflow-x-auto rounded-lg bg-muted p-1 text-muted-foreground [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",a.class)}),{default:b(()=>[w(i.$slots,"default")]),_:3},16,["class"]))}});f.__docgenInfo={exportName:"default",displayName:"TabsList",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/win-predict-ai-ui/win-predict-ai-ui/src/components/ui/tabs/TabsList.vue"]};const T=h({__name:"TabsTrigger",props:{value:{},disabled:{type:Boolean},asChild:{type:Boolean},as:{},class:{type:[Boolean,null,String,Object,Array]},variant:{default:"default"}},setup(n){const a=n,s=K(a,"class","variant"),e=O(s),i={default:"","with-icon":"gap-1.5 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0","icon-only":"size-9 p-0 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0"};return(u,c)=>(x(),y(t(qe),j({"data-slot":"tabs-trigger"},t(e),{class:t(z)("inline-flex shrink-0 items-center justify-center whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm",i[a.variant],a.class)}),{default:b(()=>[w(u.$slots,"default")]),_:3},16,["class"]))}});T.__docgenInfo={exportName:"default",displayName:"TabsTrigger",description:"",tags:{},props:[{name:"variant",defaultValue:{func:!1,value:"'default'"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/win-predict-ai-ui/win-predict-ai-ui/src/components/ui/tabs/TabsTrigger.vue"]};const v=h({__name:"TabsContent",props:{value:{},forceMount:{type:Boolean},asChild:{type:Boolean},as:{},class:{type:[Boolean,null,String,Object,Array]}},setup(n){const a=n,s=K(a,"class"),e=O(s);return(i,u)=>(x(),y(t(De),j({"data-slot":"tabs-content"},t(e),{class:t(z)("mt-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50",a.class)}),{default:b(()=>[w(i.$slots,"default")]),_:3},16,["class"]))}});v.__docgenInfo={exportName:"default",displayName:"TabsContent",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/win-predict-ai-ui/win-predict-ai-ui/src/components/ui/tabs/TabsContent.vue"]};const Ye={title:"Win Predict AI / UI / Tabs",component:m,tags:["autodocs"]};function H(){return`
  ...
  `}const P={render:()=>({components:{Tabs:m,TabsList:f,TabsTrigger:T,TabsContent:v,IconSearch:N,IconPin:V,IconPencil:R},template:Y()})},B={globals:{theme:"slate-teal-light"},render:()=>({components:{Tabs:m,TabsList:f,TabsTrigger:T,TabsContent:v,IconSearch:N,IconPin:V,IconPencil:R},template:Y()})},D={globals:{theme:"slate-teal-dark"},render:()=>({components:{Tabs:m,TabsList:f,TabsTrigger:T,TabsContent:v,IconSearch:N,IconPin:V,IconPencil:R},template:Y()})},$={render:()=>({components:{Tabs:m,TabsList:f,TabsTrigger:T,TabsContent:v,IconSearch:N,IconPin:V,IconPencil:R},template:`
  ...
  `}const U={Tabs:m,TabsList:f,TabsTrigger:T,TabsContent:v,IconGripVertical:re,IconFlag:se,IconArrowsSort:ae},M={render:()=>({components:U,template:G()})},F={globals:{theme:"slate-teal-light"},render:()=>({components:U,template:G()})},q={globals:{theme:"slate-teal-dark"},render:()=>({components:U,template:G()})};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  render: () => ({
    components: {
      Tabs,
      TabsList,
...
}`,...q.parameters?.docs?.source}}};const Ge=["Default","Light","Dark","NarrowScroll","WithIcons","WithIconsLight","WithIconsDark","IconOnly","LeagueDetail","LeagueDetailLight","LeagueDetailDark"];export{k as Dark,_ as Default,$ as IconOnly,M as LeagueDetail,q as LeagueDetailDark,F as LeagueDetailLight,S as Light,L as NarrowScroll,P as WithIcons,D as WithIconsDark,B as WithIconsLight,Ge as __namedExportsOrder,Ye as default};
