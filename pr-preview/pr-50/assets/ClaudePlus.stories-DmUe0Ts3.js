import{r as t}from"./iframe-CrnZ8d65.js";import{f as r}from"./index-vXEQPYjJ.js";import{_ as a}from"./AppHeaderShell-DREmDxoS.js";import{B as o}from"./BrandTitle-HU0jk6e3.js";import{w as d}from"./storyHelpers-BtxSlO8i.js";import"./preload-helper-QR2TdjE1.js";import"./LocaleSwitcher-Ddr6bxRF.js";import"./DropdownMenuTrigger-KAiBh7VY.js";import"./Presence-dC_Gkh_j.js";import"./Primitive-CrksTsCf.js";import"./index-BzlL2piU.js";import"./index-Dz5-xlzP.js";import"./useForwardExpose-BVWDrM11.js";import"./useId-D2sgm-yv.js";import"./createContext-DsPWDOFb.js";import"./Teleport-hzOxMrHU.js";import"./nullish-CHIgUVhi.js";import"./cn-DaT-yT0k.js";import"./RovingFocusGroup-C7YPdPzX.js";import"./ThemeToggle-DwVYbOiA.js";const l=["en","ru"],s={en:"English",ru:"Русский"},n=[{match:"Arsenal — Chelsea",league:"EPL",prob:"62%",edge:"+4.2",trendClass:"bg-chart-1"},{match:"Real Madrid — Barcelona",league:"La Liga",prob:"54%",edge:"+1.8",trendClass:"bg-chart-2"},{match:"Bayern — Dortmund",league:"Bundesliga",prob:"71%",edge:"+6.1",trendClass:"bg-chart-3"},{match:"Inter — Milan",league:"Serie A",prob:"48%",edge:"-0.5",trendClass:"bg-chart-4"},{match:"PSG — Lyon",league:"Ligue 1",prob:"67%",edge:"+3.4",trendClass:"bg-chart-5"}];function i(){return`
  ...
  `}const I={title:"Win Predict AI / UI / Claude+",tags:["autodocs"],parameters:{layout:"padded"}},e={render:()=>({components:{AppHeaderShell:a,IconLogin:r,BrandTitle:o},setup(){return{locale:t("en"),locales:l,localeLabels:s,predictions:n}},template:i()})},{ZincLight:H,ZincDark:E,SlateTealLight:_,SlateTealDark:M,ClaudePlusLight:Z,ClaudePlusDark:z}=d(e);e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AppHeaderShell,
      IconLogin,
...
}`,...e.parameters?.docs?.source}}};const R=["Default","ZincLight","ZincDark","SlateTealLight","SlateTealDark","ClaudePlusLight","ClaudePlusDark"];export{z as ClaudePlusDark,Z as ClaudePlusLight,e as Default,M as SlateTealDark,_ as SlateTealLight,E as ZincDark,H as ZincLight,R as __namedExportsOrder,I as default};
