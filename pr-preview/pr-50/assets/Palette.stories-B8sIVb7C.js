const h={title:"Win Predict AI / UI / Palette",tags:["autodocs"],parameters:{layout:"padded"}};function e(r=!1){const t=r?"nexora-glass-panel":"",a=(x,b)=>r&&b!=null?`${x}/${b}`:x;return`
  ...
  `}const s={render:()=>({template:e()})},o={globals:{theme:"zinc-light"},render:()=>({template:e()})},d={globals:{theme:"zinc-dark"},render:()=>({template:e()})},n={globals:{theme:"slate-teal-light"},render:()=>({template:e()})},l={globals:{theme:"slate-teal-dark"},render:()=>({template:e()})},c={globals:{theme:"claude-plus-light"},render:()=>({template:e()})},p={globals:{theme:"claude-plus-dark"},render:()=>({template:e()})},i={globals:{theme:"pastel-light"},render:()=>({template:e()})},m={globals:{theme:"pastel-dark"},render:()=>({template:e()})},u={globals:{theme:"nexora-light"},render:()=>({template:e(!0)})},g={globals:{theme:"nexora-dark"},render:()=>({template:e(!0)})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  render: () => ({
...
}`,...g.parameters?.docs?.source}}};const f=["Default","ZincLight","ZincDark","SlateTealLight","SlateTealDark","ClaudePlusLight","ClaudePlusDark","PastelLight","PastelDark","NexoraLight","NexoraDark"];export{p as ClaudePlusDark,c as ClaudePlusLight,s as Default,g as NexoraDark,u as NexoraLight,m as PastelDark,i as PastelLight,l as SlateTealDark,n as SlateTealLight,d as ZincDark,o as ZincLight,f as __namedExportsOrder,h as default};
