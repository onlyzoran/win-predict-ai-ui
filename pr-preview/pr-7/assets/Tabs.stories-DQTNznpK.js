import{g as ae,h as W,k as R,l as V,M as A,m as se,I as re,n as ne}from"./index-BVTm9T9-.js";import{d as h,k as J,j as oe,w as ie,o as x,l as w,p as b,b as N,e as t,r as y,h as C,n as de,H as Q,g as X,A as le,O as ue,q as ce,f as pe,K as be,I as me,C as j}from"./iframe-DcGU6j9P.js";import{l as ge,f as Z,b as fe,P as I,m as Te,w as ve,n as he,a as xe,u as O,c as we,d as ye,R as Ce,e as Ie,h as K,k as E}from"./cn-DRksd3o_.js";import"./preload-helper-EGzHFVIx.js";var _e=h({__name:"RovingFocusItem",props:{tabStopId:{type:String,required:!1},focusable:{type:Boolean,required:!1,default:!0},active:{type:Boolean,required:!1},allowShiftKey:{type:Boolean,required:!1},asChild:{type:Boolean,required:!1},as:{type:null,required:!1,default:"span"}},setup(n){const a=n,s=ge(),e=Z(),d=C(()=>a.tabStopId||e),u=C(()=>s.currentTabStopId.value===d.value),{getItems:c,CollectionItem:o}=fe();J(()=>{a.focusable&&s.onFocusableItemAdd()}),oe(()=>{a.focusable&&s.onFocusableItemRemove()}),ie(()=>a.focusable,(r,i)=>{r!==i&&(r?s.onFocusableItemAdd():s.onFocusableItemRemove())});function p(r){if(r.key==="Tab"&&r.shiftKey){s.onItemShiftTab();return}if(r.target!==r.currentTarget)return;const i=Te(r,s.orientation.value,s.dir.value);if(i!==void 0){if(r.metaKey||r.ctrlKey||r.altKey||!a.allowShiftKey&&r.shiftKey)return;r.preventDefault();let l=[...c().map(g=>g.ref).filter(g=>g.dataset.disabled!=="")];if(i==="last")l.reverse();else if(i==="prev"||i==="next"){i==="prev"&&l.reverse();const g=l.indexOf(r.currentTarget);l=s.loop.value?ve(l,g+1):l.slice(g+1)}de(()=>he(l))}}return(r,i)=>(x(),w(t(o),null,{default:b(()=>[N(t(I),{tabindex:u.value?0:-1,"data-orientation":t(s).orientation.value,"data-active":r.active?"":void 0,"data-disabled":r.focusable?void 0:"",as:r.as,"as-child":r.asChild,onMousedown:i[0]||(i[0]=l=>{r.focusable?t(s).onItemFocus(d.value):l.preventDefault()}),onFocus:i[1]||(i[1]=l=>t(s).onItemFocus(d.value)),onKeydown:p},{default:b(()=>[y(r.$slots,"default")]),_:3},8,["tabindex","data-orientation","data-active","data-disabled","as","as-child"])]),_:3}))}}),Se=_e;const[z,ke]=we("TabsRoot");var Le=h({__name:"TabsRoot",props:{defaultValue:{type:null,required:!1},orientation:{type:String,required:!1,default:"horizontal"},dir:{type:String,required:!1},activationMode:{type:String,required:!1,default:"automatic"},modelValue:{type:null,required:!1},unmountOnHide:{type:Boolean,required:!1,default:!0},asChild:{type:Boolean,required:!1},as:{type:null,required:!1}},emits:["update:modelValue"],setup(n,{emit:a}){const s=n,e=a,{orientation:d,unmountOnHide:u,dir:c}=Q(s),o=xe(c);O();const p=ae(s,"modelValue",e,{defaultValue:s.defaultValue,passive:s.modelValue===void 0}),r=X(),i=le(new Set);return ke({modelValue:p,changeModelValue:l=>{p.value=l},orientation:d,dir:o,unmountOnHide:u,activationMode:s.activationMode,baseId:Z(void 0,"reka-tabs"),tabsList:r,contentIds:i,registerContent:l=>{i.value=new Set([...i.value,l])},unregisterContent:l=>{const g=new Set(i.value);g.delete(l),i.value=g}}),(l,g)=>(x(),w(t(I),{dir:t(o),"data-orientation":t(d),"as-child":l.asChild,as:l.as},{default:b(()=>[y(l.$slots,"default",{modelValue:t(p)})]),_:3},8,["dir","data-orientation","as-child","as"]))}}),Pe=Le;function ee(n,a){return`${n}-trigger-${a}`}function te(n,a){return`${n}-content-${a}`}var Be=h({__name:"TabsContent",props:{value:{type:[String,Number],required:!0},forceMount:{type:Boolean,required:!1},asChild:{type:Boolean,required:!1},as:{type:null,required:!1}},setup(n){const a=n,{forwardRef:s}=O(),e=z(),d=C(()=>ee(e.baseId,a.value)),u=C(()=>te(e.baseId,a.value)),c=C(()=>a.value===e.modelValue.value),o=X(c.value);return J(()=>{e.registerContent(a.value),requestAnimationFrame(()=>{o.value=!1})}),ue(()=>{e.unregisterContent(a.value)}),(p,r)=>(x(),w(t(ye),{present:p.forceMount||c.value,"force-mount":""},{default:b(({present:i})=>[N(t(I),{id:u.value,ref:t(s),"as-child":p.asChild,as:p.as,role:"tabpanel","data-state":c.value?"active":"inactive","data-orientation":t(e).orientation.value,"aria-labelledby":d.value,hidden:!i,tabindex:"0",style:ce({animationDuration:o.value?"0s":void 0})},{default:b(()=>[!t(e).unmountOnHide.value||i?y(p.$slots,"default",{key:0}):pe("v-if",!0)]),_:2},1032,["id","as-child","as","data-state","data-orientation","aria-labelledby","hidden","style"])]),_:3},8,["present"]))}}),De=Be,Me=h({__name:"TabsList",props:{loop:{type:Boolean,required:!1,default:!0},asChild:{type:Boolean,required:!1},as:{type:null,required:!1}},setup(n){const a=n,{loop:s}=Q(a),{forwardRef:e,currentElement:d}=O(),u=z();return u.tabsList=d,(c,o)=>(x(),w(t(Ce),{"as-child":"",orientation:t(u).orientation.value,dir:t(u).dir.value,loop:t(s)},{default:b(()=>[N(t(I),{ref:t(e),role:"tablist","as-child":c.asChild,as:c.as,"aria-orientation":t(u).orientation.value},{default:b(()=>[y(c.$slots,"default")]),_:3},8,["as-child","as","aria-orientation"])]),_:3},8,["orientation","dir","loop"]))}}),$e=Me,Fe=h({__name:"TabsTrigger",props:{value:{type:[String,Number],required:!0},disabled:{type:Boolean,required:!1,default:!1},asChild:{type:Boolean,required:!1},as:{type:null,required:!1,default:"button"}},setup(n){const a=n,{forwardRef:s}=O(),e=z(),d=C(()=>ee(e.baseId,a.value)),u=C(()=>e.contentIds.value.has(a.value)?te(e.baseId,a.value):void 0),c=C(()=>a.value===e.modelValue.value);return(o,p)=>(x(),w(t(Se),{"as-child":"",focusable:!o.disabled,active:c.value},{default:b(()=>[N(t(I),{id:d.value,ref:t(s),role:"tab",type:o.as==="button"?"button":void 0,as:o.as,"as-child":o.asChild,"aria-selected":c.value?"true":"false","aria-controls":u.value,"data-state":c.value?"active":"inactive",disabled:o.disabled,"data-disabled":o.disabled?"":void 0,"data-orientation":t(e).orientation.value,onMousedown:p[0]||(p[0]=me(r=>{!o.disabled&&r.ctrlKey===!1?t(e).changeModelValue(o.value):r.preventDefault()},["left"])),onKeydown:p[1]||(p[1]=be(r=>t(e).changeModelValue(o.value),["enter","space"])),onFocus:p[2]||(p[2]=()=>{const r=t(e).activationMode!=="manual";!c.value&&!o.disabled&&r&&t(e).changeModelValue(o.value)})},{default:b(()=>[y(o.$slots,"default")]),_:3},8,["id","type","as","as-child","aria-selected","aria-controls","data-state","disabled","data-disabled","data-orientation"])]),_:3},8,["focusable","active"]))}}),qe=Fe;const m=h({__name:"Tabs",props:{defaultValue:{},orientation:{default:"horizontal"},dir:{},activationMode:{},modelValue:{},unmountOnHide:{type:Boolean},asChild:{type:Boolean},as:{}},emits:["update:modelValue"],setup(n,{emit:a}){const d=Ie(n,a);return(u,c)=>(x(),w(t(Pe),j({"data-slot":"tabs"},t(d)),{default:b(()=>[y(u.$slots,"default")]),_:3},16))}});m.__docgenInfo={exportName:"default",displayName:"Tabs",description:"",tags:{},props:[{name:"orientation",defaultValue:{func:!1,value:"'horizontal'"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/win-predict-ai-ui/win-predict-ai-ui/src/components/ui/tabs/Tabs.vue"]};const f=h({__name:"TabsList",props:{loop:{type:Boolean},asChild:{type:Boolean},as:{},class:{type:[Boolean,null,String,Object,Array]}},setup(n){const a=n,s=W(a,"class"),e=K(s);return(d,u)=>(x(),w(t($e),j({"data-slot":"tabs-list"},t(e),{class:t(E)("inline-flex h-9 w-full max-w-full items-center justify-start gap-1 overflow-x-auto rounded-lg bg-muted p-1 text-muted-foreground [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden",a.class)}),{default:b(()=>[y(d.$slots,"default")]),_:3},16,["class"]))}});f.__docgenInfo={exportName:"default",displayName:"TabsList",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/win-predict-ai-ui/win-predict-ai-ui/src/components/ui/tabs/TabsList.vue"]};const T=h({__name:"TabsTrigger",props:{value:{},disabled:{type:Boolean},asChild:{type:Boolean},as:{},class:{type:[Boolean,null,String,Object,Array]},variant:{default:"default"}},setup(n){const a=n,s=W(a,"class","variant"),e=K(s),d={default:"","with-icon":"gap-1.5 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0","icon-only":"size-9 p-0 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0"};return(u,c)=>(x(),w(t(qe),j({"data-slot":"tabs-trigger"},t(e),{class:t(E)("inline-flex shrink-0 items-center justify-center whitespace-nowrap rounded-md px-3 py-1 text-sm font-medium transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm",d[a.variant],a.class)}),{default:b(()=>[y(u.$slots,"default")]),_:3},16,["class"]))}});T.__docgenInfo={exportName:"default",displayName:"TabsTrigger",description:"",tags:{},props:[{name:"variant",defaultValue:{func:!1,value:"'default'"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/win-predict-ai-ui/win-predict-ai-ui/src/components/ui/tabs/TabsTrigger.vue"]};const v=h({__name:"TabsContent",props:{value:{},forceMount:{type:Boolean},asChild:{type:Boolean},as:{},class:{type:[Boolean,null,String,Object,Array]}},setup(n){const a=n,s=W(a,"class"),e=K(s);return(d,u)=>(x(),w(t(De),j({"data-slot":"tabs-content"},t(e),{class:t(E)("mt-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50",a.class)}),{default:b(()=>[y(d.$slots,"default")]),_:3},16,["class"]))}});v.__docgenInfo={exportName:"default",displayName:"TabsContent",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/win-predict-ai-ui/win-predict-ai-ui/src/components/ui/tabs/TabsContent.vue"]};const je={title:"Win Predict AI / UI / Tabs",component:m,tags:["autodocs"]};function H(){return`
  ...
  `}const P={render:()=>({components:{Tabs:m,TabsList:f,TabsTrigger:T,TabsContent:v,IconSearch:A,IconPin:V,IconPencil:R},template:G()})},B={globals:{theme:"win-predict-light"},render:()=>({components:{Tabs:m,TabsList:f,TabsTrigger:T,TabsContent:v,IconSearch:A,IconPin:V,IconPencil:R},template:G()})},D={globals:{theme:"win-predict-dark"},render:()=>({components:{Tabs:m,TabsList:f,TabsTrigger:T,TabsContent:v,IconSearch:A,IconPin:V,IconPencil:R},template:G()})},M={render:()=>({components:{Tabs:m,TabsList:f,TabsTrigger:T,TabsContent:v,IconSearch:A,IconPin:V,IconPencil:R},template:`
  ...
  `}const U={Tabs:m,TabsList:f,TabsTrigger:T,TabsContent:v,IconGripVertical:ne,IconFlag:re,IconArrowsSort:se},$={render:()=>({components:U,template:Y()})},F={globals:{theme:"win-predict-light"},render:()=>({components:U,template:Y()})},q={globals:{theme:"win-predict-dark"},render:()=>({components:U,template:Y()})};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  render: () => ({
    components: {
      Tabs,
      TabsList,
...
}`,...q.parameters?.docs?.source}}};const Oe=["Default","Light","Dark","NarrowScroll","WithIcons","WithIconsLight","WithIconsDark","IconOnly","LeagueDetail","LeagueDetailLight","LeagueDetailDark"];export{k as Dark,_ as Default,M as IconOnly,$ as LeagueDetail,q as LeagueDetailDark,F as LeagueDetailLight,S as Light,L as NarrowScroll,P as WithIcons,D as WithIconsDark,B as WithIconsLight,Oe as __namedExportsOrder,je as default};
