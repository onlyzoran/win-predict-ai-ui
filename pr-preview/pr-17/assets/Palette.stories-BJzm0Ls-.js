const v={title:"Win Predict AI / UI / Palette",tags:["autodocs"],parameters:{layout:"padded"}};function h(){return`
      <section>
  ...
  `}function e(r=!1,f=!1){const t=r?"nexora-glass-panel":"",a=(g,b)=>r&&b!=null?`${g}/${b}`:g;return`
    <div class="mx-auto flex w-full max-w-3xl flex-col gap-8">
      <section>
        ...
        <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <div class="${t} rounded-lg border border-border bg-${a("background",60)} p-3 text-foreground">
            <p class="text-xs font-medium">background</p>
            <p class="mt-1 text-xs opacity-80">Sample text</p>
          </div>
          <div class="${t} rounded-lg border border-border bg-${a("card",70)} p-3 text-card-foreground">
            <p class="text-xs font-medium">card</p>
            <p class="mt-1 text-xs opacity-80">Sample text</p>
          </div>
          <div class="${t} rounded-lg border border-border bg-${a("popover",75)} p-3 text-popover-foreground">
            <p class="text-xs font-medium">popover</p>
            <p class="mt-1 text-xs opacity-80">Sample text</p>
          </div>
          <div class="${t} rounded-lg border border-border bg-${r?"muted/55":"muted"} p-3 text-muted-foreground">
            <p class="text-xs font-medium">muted</p>
            <p class="mt-1 text-xs opacity-80">Sample text</p>
          </div>
          <div class="${t} rounded-lg border border-border bg-${r?"secondary/60":"secondary"} p-3 text-secondary-foreground">
            <p class="text-xs font-medium">secondary</p>
            <p class="mt-1 text-xs opacity-80">Sample text</p>
          </div>
          <div class="${t} rounded-lg border border-border bg-${r?"accent/55":"accent"} p-3 text-accent-foreground">
      ...
      <section>
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
          <div class="${t} rounded-lg border border-sidebar-border bg-${r?"sidebar/75":"sidebar"} p-3 text-sidebar-foreground">
            <p class="text-xs font-medium">sidebar</p>
            <p class="mt-1 text-xs opacity-80">Nav item</p>
          </div>
          <div class="${t} rounded-lg border border-sidebar-border bg-${r?"sidebar-accent/55":"sidebar-accent"} p-3 text-sidebar-accent-foreground">
      ...
      <section>
        ...
        <div class="${t} flex h-24 items-end gap-2 rounded-lg border border-border bg-${a("card",70)} p-4">
  ...
  `}const s={render:()=>({template:e()})},o={globals:{theme:"zinc-light"},render:()=>({template:e()})},d={globals:{theme:"zinc-dark"},render:()=>({template:e()})},n={globals:{theme:"slate-teal-light"},render:()=>({template:e()})},l={globals:{theme:"slate-teal-dark"},render:()=>({template:e()})},c={globals:{theme:"claude-plus-light"},render:()=>({template:e()})},i={globals:{theme:"claude-plus-dark"},render:()=>({template:e()})},p={globals:{theme:"pastel-light"},render:()=>({template:e(!1,!0)})},m={globals:{theme:"pastel-dark"},render:()=>({template:e(!1,!0)})},u={globals:{theme:"nexora-light"},render:()=>({template:e(!0)})},x={globals:{theme:"nexora-dark"},render:()=>({template:e(!0)})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  render: () => ({
...
}`,...x.parameters?.docs?.source}}};const y=["Default","ZincLight","ZincDark","SlateTealLight","SlateTealDark","ClaudePlusLight","ClaudePlusDark","PastelLight","PastelDark","NexoraLight","NexoraDark"];export{i as ClaudePlusDark,c as ClaudePlusLight,s as Default,x as NexoraDark,u as NexoraLight,m as PastelDark,p as PastelLight,l as SlateTealDark,n as SlateTealLight,d as ZincDark,o as ZincLight,y as __namedExportsOrder,v as default};
