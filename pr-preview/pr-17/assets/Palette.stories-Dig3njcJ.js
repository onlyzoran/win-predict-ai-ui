const m={title:"Win Predict AI / UI / Palette",tags:["autodocs"],parameters:{layout:"padded"}};function p(){return`
      <section>
  ...
  `}const t={render:()=>({template:e()})},r={globals:{theme:"zinc-light"},render:()=>({template:e()})},s={globals:{theme:"zinc-dark"},render:()=>({template:e()})},a={globals:{theme:"slate-teal-light"},render:()=>({template:e()})},o={globals:{theme:"slate-teal-dark"},render:()=>({template:e()})},d={globals:{theme:"claude-plus-light"},render:()=>({template:e()})},l={globals:{theme:"claude-plus-dark"},render:()=>({template:e()})},n={globals:{theme:"pastel-light"},render:()=>({template:e(!0)})},c={globals:{theme:"pastel-dark"},render:()=>({template:e(!0)})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: () => ({
...
}`,...c.parameters?.docs?.source}}};const u=["Default","ZincLight","ZincDark","SlateTealLight","SlateTealDark","ClaudePlusLight","ClaudePlusDark","PastelLight","PastelDark"];export{l as ClaudePlusDark,d as ClaudePlusLight,t as Default,c as PastelDark,n as PastelLight,o as SlateTealDark,a as SlateTealLight,s as ZincDark,r as ZincLight,u as __namedExportsOrder,m as default};
