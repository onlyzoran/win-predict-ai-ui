const b={title:"Win Predict AI / UI / Palette",tags:["autodocs"],parameters:{layout:"padded"}};function t(r=!1){const e=r?"nexora-glass-panel":"",a=(u,x)=>r&&x!=null?`${u}/${x}`:u;return`
  ...
  `}const s={render:()=>({template:t()})},o={globals:{theme:"zinc-light"},render:()=>({template:t()})},d={globals:{theme:"zinc-dark"},render:()=>({template:t()})},n={globals:{theme:"slate-teal-light"},render:()=>({template:t()})},l={globals:{theme:"slate-teal-dark"},render:()=>({template:t()})},c={globals:{theme:"claude-plus-light"},render:()=>({template:t()})},p={globals:{theme:"claude-plus-dark"},render:()=>({template:t()})},i={globals:{theme:"nexora-light"},render:()=>({template:t(!0)})},m={globals:{theme:"nexora-dark"},render:()=>({template:t(!0)})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  render: () => ({
...
}`,...m.parameters?.docs?.source}}};const g=["Default","ZincLight","ZincDark","SlateTealLight","SlateTealDark","ClaudePlusLight","ClaudePlusDark","NexoraLight","NexoraDark"];export{p as ClaudePlusDark,c as ClaudePlusLight,s as Default,m as NexoraDark,i as NexoraLight,l as SlateTealDark,n as SlateTealLight,d as ZincDark,o as ZincLight,g as __namedExportsOrder,b as default};
