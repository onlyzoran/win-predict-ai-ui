import{r as a}from"./iframe-Co1gEe7Z.js";import{f as o}from"./index-BJH0Ay5l.js";import{_ as n}from"./AppHeaderShell-ZeNId2ZQ.js";import"./preload-helper-CE2h5UKx.js";import"./LocaleSwitcher-BQQXdcw1.js";import"./DropdownMenuTrigger-oVvSThB4.js";import"./Presence-CJcLSHfj.js";import"./Primitive-phwxLrPC.js";import"./index-BwSErBIk.js";import"./index-BSlgtreQ.js";import"./useForwardExpose-BG-F8nu2.js";import"./useId-hjJZh0PL.js";import"./createContext-3f_-hNPN.js";import"./Teleport-CzF24d0o.js";import"./nullish-CHIgUVhi.js";import"./cn-DaT-yT0k.js";import"./RovingFocusGroup-DVwdMaLj.js";import"./ThemeToggle-D13tDWYX.js";const s=["en","ru"],l={en:"English",ru:"Русский"},d=[{match:"Arsenal — Chelsea",league:"EPL",prob:"62%",edge:"+4.2",trendClass:"bg-chart-1"},{match:"Real Madrid — Barcelona",league:"La Liga",prob:"54%",edge:"+1.8",trendClass:"bg-chart-2"},{match:"Bayern — Dortmund",league:"Bundesliga",prob:"71%",edge:"+6.1",trendClass:"bg-chart-3"},{match:"Inter — Milan",league:"Serie A",prob:"48%",edge:"-0.5",trendClass:"bg-chart-4"},{match:"PSG — Lyon",league:"Ligue 1",prob:"67%",edge:"+3.4",trendClass:"bg-chart-5"}];function c(){return`
  ...
  `}const P={title:"Win Predict AI / UI / Nexora",tags:["autodocs"],parameters:{layout:"padded"}},e={render:()=>({components:{AppHeaderShell:n,IconLogin:o},setup(){return{locale:a("en"),locales:s,localeLabels:l,predictions:d}},template:c()})},t={globals:{theme:"nexora-light"},render:()=>({components:{AppHeaderShell:n,IconLogin:o},setup(){return{locale:a("en"),locales:s,localeLabels:l,predictions:d}},template:c()})},r={globals:{theme:"nexora-dark"},render:()=>({components:{AppHeaderShell:n,IconLogin:o},setup(){return{locale:a("en"),locales:s,localeLabels:l,predictions:d}},template:c()})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  render: () => ({
    components: {
      AppHeaderShell,
      IconLogin
...
}`,...r.parameters?.docs?.source}}};const T=["Default","Light","Dark"];export{r as Dark,e as Default,t as Light,T as __namedExportsOrder,P as default};
