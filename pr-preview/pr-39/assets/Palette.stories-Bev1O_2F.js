const p={title:"Win Predict AI / UI / Palette",tags:["autodocs"],parameters:{layout:"padded"}};function e(){return`
  ...
  `}const t={render:()=>({template:e()})},r={globals:{theme:"zinc-light"},render:()=>({template:e()})},a={globals:{theme:"zinc-dark"},render:()=>({template:e()})},s={globals:{theme:"slate-teal-light"},render:()=>({template:e()})},d={globals:{theme:"slate-teal-dark"},render:()=>({template:e()})},o={globals:{theme:"claude-plus-light"},render:()=>({template:e()})},l={globals:{theme:"claude-plus-dark"},render:()=>({template:e()})},n={globals:{theme:"nexora-light"},render:()=>({template:e()})},c={globals:{theme:"nexora-dark"},render:()=>({template:e()})};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: () => ({
...
}`,...c.parameters?.docs?.source}}};const i=["Default","ZincLight","ZincDark","SlateTealLight","SlateTealDark","ClaudePlusLight","ClaudePlusDark","NexoraLight","NexoraDark"];export{l as ClaudePlusDark,o as ClaudePlusLight,t as Default,c as NexoraDark,n as NexoraLight,d as SlateTealDark,s as SlateTealLight,a as ZincDark,r as ZincLight,i as __namedExportsOrder,p as default};
