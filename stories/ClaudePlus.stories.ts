...
const predictions = [
  { match: 'Arsenal — Chelsea', league: 'EPL', prob: '62%', edge: '+4.2', trendClass: 'bg-chart-1' },
  { match: 'Real Madrid — Barcelona', league: 'La Liga', prob: '54%', edge: '+1.8', trendClass: 'bg-chart-2' },
  { match: 'Bayern — Dortmund', league: 'Bundesliga', prob: '71%', edge: '+6.1', trendClass: 'bg-chart-3' },
  { match: 'Inter — Milan', league: 'Serie A', prob: '48%', edge: '-0.5', trendClass: 'bg-chart-4' },
  { match: 'PSG — Lyon', league: 'Ligue 1', prob: '67%', edge: '+3.4', trendClass: 'bg-chart-5' },
]
...
const meta = {
  title: 'Win Predict AI / UI / Claude+',
  tags: ['autodocs'],
  parameters: {
    layout: 'padded',
  },
